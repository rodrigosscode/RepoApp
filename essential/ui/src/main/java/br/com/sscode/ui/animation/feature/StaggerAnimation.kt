package br.com.sscode.ui.animation.feature
...
import br.com.sscode.ui.animation.duration.LARGE_EXPAND_DURATION
import br.com.sscode.ui.animation.interpolator.LINEAR_OUT_SLOW_IN
...
class StaggerAnimation : Fade(IN) {
